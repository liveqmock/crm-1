...
import com.deppon.fin.dept.WSFinanceWebserviceFacadeSrvProxy;
import com.deppon.fin.dept.WSFinanceWebserviceFacadeSrvProxyServiceLocator;
 ...
 * @时间：2012-10-17
 * */
public class FINServiceLocator extends
		WSFinanceWebserviceFacadeSrvProxyServiceLocator {
	 ...
	 * */
	@Override
	public WSFinanceWebserviceFacadeSrvProxy getWSFinanceWebserviceFacade()
			throws ServiceException {
		// 登录FIN系统
		login();
		InterfaceAddressConfig config = provider.getAddressMap(serviceCode);
		super.setWSFinanceWebserviceFacadeEndpointAddress(config.getAddress());
		return super.getWSFinanceWebserviceFacade();
	}
