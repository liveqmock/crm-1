...
import com.deppon.fin.bankNum.WSFinBankNumberCrmFacadeSrvProxy;
import com.deppon.fin.bankNum.WSFinBankNumberCrmFacadeSrvProxyServiceLocator;
 ...
 * @时间：2012-10-17
 * */
public class FINBankNumberCrmFacadeLocator extends
		WSFinBankNumberCrmFacadeSrvProxyServiceLocator {
	 ...
	 * */
	@Override
	public WSFinBankNumberCrmFacadeSrvProxy getWSFinBankNumberCrmFacade()
			throws ServiceException {
		// 登录FIN系统
		login();
		InterfaceAddressConfig config = provider.getAddressMap(serviceCode);
		super.setWSFinBankNumberCrmFacadeEndpointAddress(config.getAddress());
		return super.getWSFinBankNumberCrmFacade();
	}
