...
import com.deppon.crm.module.client.sync.foss.TCustAccountOperation;
import com.deppon.crm.module.client.sync.foss.TCustContractOperation;
import com.deppon.crm.module.client.sync.foss.TCustContractdeptOperation;
import com.deppon.crm.module.client.sync.foss.TCustCustbasedataOperation;
import com.deppon.crm.module.client.sync.foss.TCustCustlinkmanOperation;
import com.deppon.crm.module.client.sync.foss.TCustPreferenceaddressOperation;
import com.deppon.crm.module.client.sync.foss.TCustPreferentialOperation;
import com.deppon.crm.module.client.sync.foss.TCustShuttleaddressOperation;

public class WaitingSendFossRequest {
	/**
	 * 0:全部相关表，先删除，再插入。
	 */
	private int pattern;
