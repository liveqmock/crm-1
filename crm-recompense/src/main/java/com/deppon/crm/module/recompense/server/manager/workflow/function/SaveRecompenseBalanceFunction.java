 ...
 * 
 * <p>
 * Description:保存理赔冲账<br />
 * </p>
 * @title SaveRecompenseBalanceFunction.java
 * @package com.deppon.crm.module.recompense.server.manager.workflow.function 
 * @author roy
 * @version 0.1 2013-1-21
 */
public class SaveRecompenseBalanceFunction implements FunctionProvider {
	//理赔service
	...
	public void execute(Map transientVars, Map args, PropertySet ps)
		...
		recompenseService.updateRecompenseBalanceInfo(app);
