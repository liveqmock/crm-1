 ...
 * 2012-11-19T15:15:31.125+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "WorkFlowServiceService", 
                  wsdlLocation = "http://192.168.17.133:8080/dipApp/WorkFlowService?wsdl",
...
public class WorkFlowServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.17.133:8080/dipApp/WorkFlowService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WorkFlowServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.17.133:8080/dipApp/WorkFlowService?wsdl");
        }
        WSDL_LOCATION = url;
    }
