...
@XmlRootElement(name = "deleteWorkFlow")
public class DeleteWorkFlow {

    @XmlElementRef(name = "in0", namespace = "http://www.primeton.com/WorkFlowService", type = JAXBElement.class)
    protected JAXBElement<String> in0;
    @XmlElementRef(name = "in1", namespace = "http://www.primeton.com/WorkFlowService", type = JAXBElement.class)
