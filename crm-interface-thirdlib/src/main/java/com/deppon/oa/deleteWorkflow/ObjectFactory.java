 ...
 * generated in the com.deppon.oa.deleteWorkflow package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateWorkFlowIn1_QNAME = new QName("http://www.primeton.com/WorkFlowService", "in1");
    private final static QName _CreateWorkFlowIn0_QNAME = new QName("http://www.primeton.com/WorkFlowService", "in0");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deppon.oa.deleteWorkflow
     * 
     */
    ...
    public JAXBElement<String> createCreateWorkFlowIn1(String value) {
        return new JAXBElement<String>(_CreateWorkFlowIn1_QNAME, String.class, CreateWorkFlow.class, value);
    }
    ...
    public JAXBElement<String> createCreateWorkFlowIn0(String value) {
        return new JAXBElement<String>(_CreateWorkFlowIn0_QNAME, String.class, CreateWorkFlow.class, value);
    }
    ...
    public JAXBElement<String> createDeleteWorkFlowIn1(String value) {
        return new JAXBElement<String>(_CreateWorkFlowIn1_QNAME, String.class, DeleteWorkFlow.class, value);
    }
    ...
    public JAXBElement<String> createDeleteWorkFlowIn0(String value) {
        return new JAXBElement<String>(_CreateWorkFlowIn0_QNAME, String.class, DeleteWorkFlow.class, value);
    }
    ...
    public JAXBElement<String> createDrawbackWorkFlowIn0(String value) {
        return new JAXBElement<String>(_CreateWorkFlowIn0_QNAME, String.class, DrawbackWorkFlow.class, value);
    }
