...
@XmlRootElement(name = "queryGoodDelay")
public class QueryGoodDelay {

    @XmlElementRef(name = "in0", namespace = "http://www.primeton.com/OAErrorForCRMImplService", type = JAXBElement.class)
