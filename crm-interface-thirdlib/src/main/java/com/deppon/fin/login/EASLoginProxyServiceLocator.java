...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements com.deppon.fin.login.EASLoginProxyService {
    ...
    private java.lang.String EASLogin_address = "http://192.168.17.124:6888/ormrpc/services/EASLogin";
    ...
    public com.deppon.fin.login.EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.deppon.fin.login.EASLoginSoapBindingStub _stub = new com.deppon.fin.login.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.deppon.fin.login.EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                com.deppon.fin.login.EASLoginSoapBindingStub _stub = new com.deppon.fin.login.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://192.168.14.8:6888/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://192.168.14.8:6888/ormrpc/services/EASLogin", "EASLogin"));
        }
