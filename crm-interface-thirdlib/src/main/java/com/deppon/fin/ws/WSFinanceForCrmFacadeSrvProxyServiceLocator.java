...
public class WSFinanceForCrmFacadeSrvProxyServiceLocator extends org.apache.axis.client.Service implements com.deppon.fin.ws.WSFinanceForCrmFacadeSrvProxyService {
    ...
    private java.lang.String WSFinanceForCrmFacade_address = "http://192.168.17.124:6888/ormrpc/services/WSFinanceForCrmFacade";
    ...
    public com.deppon.fin.ws.WSFinanceForCrmFacadeSrvProxy getWSFinanceForCrmFacade() throws javax.xml.rpc.ServiceException {
    ...
    public com.deppon.fin.ws.WSFinanceForCrmFacadeSrvProxy getWSFinanceForCrmFacade(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.deppon.fin.ws.WSFinanceForCrmFacadeSoapBindingStub _stub = new com.deppon.fin.ws.WSFinanceForCrmFacadeSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.deppon.fin.ws.WSFinanceForCrmFacadeSrvProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                com.deppon.fin.ws.WSFinanceForCrmFacadeSoapBindingStub _stub = new com.deppon.fin.ws.WSFinanceForCrmFacadeSoapBindingStub(new java.net.URL(WSFinanceForCrmFacade_address), this);
                _stub.setPortName(getWSFinanceForCrmFacadeWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://192.168.14.8:6888/ormrpc/services/WSFinanceForCrmFacade", "WSFinanceForCrmFacadeSrvProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://192.168.14.8:6888/ormrpc/services/WSFinanceForCrmFacade", "WSFinanceForCrmFacade"));
        }
