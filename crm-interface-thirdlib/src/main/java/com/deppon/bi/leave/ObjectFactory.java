 ...
 * generated in the com.deppon.bi.leave package. 
...
public class ObjectFactory {
    ...
    private final static QName _NewOperationResponseOut1_QNAME = new QName("http://www.example.org/CRM_CusStaByNum/", "out1");
    private final static QName _NewOperationIn0_QNAME = new QName("http://www.example.org/CRM_CusStaByNum/", "in0");
    private final static QName _NewOperationIn1_QNAME = new QName("http://www.example.org/CRM_CusStaByNum/", "in1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deppon.bi.leave
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/CRM_CusStaByNum/", name = "out1", scope = NewOperationResponse.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/CRM_CusStaByNum/", name = "in0", scope = NewOperation.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.example.org/CRM_CusStaByNum/", name = "in1", scope = NewOperation.class)
