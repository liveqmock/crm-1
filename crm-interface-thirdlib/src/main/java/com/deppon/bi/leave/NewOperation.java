...
public class NewOperation {
    ...
    @XmlElementRef(name = "in0", namespace = "http://www.example.org/CRM_CusStaByNum/", type = JAXBElement.class)
    protected JAXBElement<String> in0;
    @XmlElementRef(name = "in1", namespace = "http://www.example.org/CRM_CusStaByNum/", type = JAXBElement.class)
