		...
		getItems : function() {
			...
			return [{
				...
				items : [{
					...
					fieldLabel:i18n('i18n.memberView.taxRegistrationNumber'),//'税号',
	...
	Ext.define("ItemBasiInfor", {					//2.1基础信息
		...
		getItems : function() {
			return [{
				...
				// }, 
				{
					fieldLabel : i18n("i18n.memberView.whetherSpecialcustomers"),//TODO: 12.特殊客户
					name : CONFIGNAME.get("BI_whetherSpecialcustomers")
				}, {
					fieldLabel : i18n("i18n.memberView.whetherImportantCustomers"),//TODO:13.重要客户
				...
				var fnSuccess = function(json) {
					if(!Ext.isEmpty(json.contractView)) {
						...
						if(!Ext.isEmpty(contract.get(CONFIGNAME.get("contract_preferential")))) {
							...
							var insuredPriceRate = Ext.isEmpty(preferential.insuredPriceRate)?0:preferential.insuredPriceRate;
							var receivePriceRate	= Ext.isEmpty(preferential.receivePriceRate)?0:preferential.receivePriceRate;
							var deliveryPriceRate	= Ext.isEmpty(preferential.deliveryPriceRate)?0:preferential.deliveryPriceRate;
							var chargeRebate		= Ext.isEmpty(preferential.chargeRebate)?0:preferential.chargeRebate;
							var agentgathRate		= Ext.isEmpty(preferential.agentgathRate)?0:preferential.agentgathRate;
						...
						//25.最后修改时间
						contract.set(CONFIGNAME.get("contract_lastModifyDate"),renderDate(json.contractView.contract.modifyDate));
...
//				}
	...
	Ext.define("OperatingDecisionC", {			//10.2.2
		...
		items : [{
			xtype : "panel",
			html : '<table><tr><td>' + i18n("i18n.memberView.month") + '</td></tr><tr><td>' + i18n("i18n.memberView.startingVolumeOfUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.startingNumberOfVotesUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.toReachTheVolumeOfUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.reachTheNumberOfVotesUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.advantageBusinessAccounted") + '</td></tr><tr><td>' + i18n("i18n.memberView.automotiveAccountedFor") + '</td></tr><tr><td>' + i18n("i18n.memberView.insuranceUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.paulCampRatio") + '</td></tr><tr><td>' + i18n("i18n.memberView.claimAmountUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.packingChargesUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.packageBattalionRatio") + '</td></tr><tr><td>' + i18n("i18n.memberView.theAmountOfPaymentCollectionUnit") + '</td></tr><tr><td>' + i18n("i18n.memberView.collectionOfMoreThan") + '</td></tr><tr><td>' + i18n("i18n.memberView.cnlineBusiness") + '</td></tr><tr><td>' + i18n("i18n.memberView.callCentersAccounted") + '</td></tr><tr><td>' + i18n("i18n.memberView.theOperatingRoomAccounted") + '</td></tr><tr><td>' + i18n("i18n.memberView.third-partyChannels") + "</td></tr></table>",
			width : "100%",
			padding : 0,
			margin : 0,
			flex : 1
	...
	Ext.define("InfoTabPanel", {
		...
		initComponent : function() {
			...
			me.items = [me.info0, me.info1, me.info2, me.info3, me.info4, me.info5, me.info6, me.info8, me.info9], 
			me.callParent()
		}
	});
