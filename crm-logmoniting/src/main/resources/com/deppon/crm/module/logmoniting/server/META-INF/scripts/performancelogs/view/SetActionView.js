			...
			items:[
					{
						...
						allowBlank:false,
						mouseWheelEnabled:false,
						maxText:i18n('i18n.Logcontrol.maxValueNotice'),
						maxValue:0.99,
						minValue:0,
						hideTrigger:true,
						name:'countFloat'
...
//					            margin:'0 0 0 0',
					            ...
					            listeners:{
					            	change:function(item){
					            		...
					            		if(item.value){
					            			emailAdress.setValue(i18n('i18n.Logcontrol.emailSendNotice1'));
					            		}else{
					            			emailAdress.setValue(i18n('i18n.Logcontrol.emailSendNotice2'));
					            		}
					            	}
					            }
					        }, {
...
//						regexText:i18n('i18n.Logcontrol.pleaseInfoRightEmail'),
						width:400,
						readOnly:true,
						value:i18n('i18n.Logcontrol.emailSendNotice2'),
						id:'mailPerson_id',
						name:'mailPerson'
					}
			 ]
