 ...
 * @version 2014-3-11
 */
public interface IWarnLostCustSerivce {
		/**
	     * <p>
	     ...
	     */
		public List<WarnLostCust> searchWarnLostCust(String deptStandardCode,String level,String[] para,Date beginTime,Date endTime);
		 ...
		 */
		List<WarnLostInfoFor360> searchWarnLostCustFor360View(
				String deptid, String custNumber, String custName,
