...
public class PathAnalysisInfo {
	...
	/**
	 * @author 苏玉军
	 * @description 二期新增，经济快递票数
	 */
	//上月经济快递票数
	private int lastEconomyExpressVotes;
	//本月经济快递票数
	private int currentEconomyExpressVotes;
	...
	public int getLastEconomyExpressVotes() {
		return lastEconomyExpressVotes;
	}
	public void setLastEconomyExpressVotes(int lastEconomyExpressVotes) {
		this.lastEconomyExpressVotes = lastEconomyExpressVotes;
	}
	public int getCurrentEconomyExpressVotes() {
		return currentEconomyExpressVotes;
	}
	public void setCurrentEconomyExpressVotes(int currentEconomyExpressVotes) {
		this.currentEconomyExpressVotes = currentEconomyExpressVotes;
	}
