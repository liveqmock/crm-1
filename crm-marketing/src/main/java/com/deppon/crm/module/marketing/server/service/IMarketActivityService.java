 ...
 * </p>
 * @title IMarketActivityService.java
 * @package com.deppon.crm.module.marketing.server.service 
 * @author ZhouYuan
 * @version 2013-04-19
 */
...
public interface IMarketActivityService {
	 ...
	 * @return int
	 */
	int deleteActivityDeptByActivityId(String activityId);
	/**
	 * 
	 * <p>
	 * 根据ID删除参与部门<br />
	 ...
	 */
	 List<LineDept> searchLineDeptByTypeAndActivityId(String activityId,String conditionType);
	 /**
	 * 
	 * <p>
	 ...
	 * @return int
	 */
	 int deleteClientBaseByRelationId(String relationId,String status);
	 /**
	 * 
	 * <p>
	 ...
	 */
	 List<ActivityClientBase> searchActivityClientByName(String clientBaseName,User user,String clientBaseStatus,
	 ...
	 * @return ActivityClientBase
	 */
	 int countActivityClientByName(String clientBaseName,User user,String clientBaseStatus,String deptCharacter,String[] clients);
	/**
	 * 
	 * <p>
	 ...
	 */
	  List<ActivityClientBase> searchActivityClientByMultipleCondition(String activityId,String clientBaseStatus,List<ActivityClientBase> clients);
	/**
	 * 
	 * <p>
	 * 根据关联ID客户群<br />
	 ...
	 * @return List<ActivityClientBase>
	 */
	  ActivityClientBase searchActivityClientByReId(String id);
	/**
	 * 
	 * <p>
	 * 根据客户群ID列表查询客户群<br />
	 ...
	 */
	  int searchUpdateAuth(String activityId,String userId);
	/**
	 * 
	 * <p>
	 ...
	 * @return int 1代表有权限 0代表没有权限
	 */
	  List<ActivityClientBase> searchActivityClientByActivityId(String activityId);
	/**
	 * 
	 * <p>
	 ...
	 * @version 0.1 2014-4-10
	 */
	  List<MarketActivity> searchMarketActivityForMarketPlan(String activityName,String activityCategory);
	/**
	 * 
	 * <p>
	 ...
	 * @version 0.1 2014-4-10
	 */
	  List<ActivityOption> searchActivityOptionByActivityIdAndType(String activityId,String infoType);
	/**
	 * 
	 * <p>
	 * 计算同名的市场推广活动数量<br />
