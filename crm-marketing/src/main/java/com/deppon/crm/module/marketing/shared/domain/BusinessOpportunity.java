...
public class BusinessOpportunity extends BaseEntity {
	...
	public void setIsBidProject(String isBidProject) {
		this.isBidProject = StringUtils.trim(isBidProject);
	}
	...
	public void setIsBOConfirm(String isBOConfirm) {
		this.isBOConfirm = StringUtils.trim(isBOConfirm);
	}
	...
	public void setBoDesc(String boDesc) {
		this.boDesc = StringUtils.trim(boDesc);
	}
	...
	public void setCustomerDemandDesc(String customerDemandDesc) {
		this.customerDemandDesc = StringUtils.trim(customerDemandDesc);
	}
	...
	public void setCompetitiveInfo(String competitiveInfo) {
		this.competitiveInfo = StringUtils.trim(competitiveInfo);
	}
	...
	public void setSolutionDesc(String solutionDesc) {
		this.solutionDesc = StringUtils.trim(solutionDesc);
	}
	...
	public void setCloseReasonDesc(String closeReasonDesc) {
		this.closeReasonDesc = StringUtils.trim(closeReasonDesc);
	}
	...
	public void setCloseReasonCode(String closeReasonCode) {
		this.closeReasonCode = StringUtils.trim(closeReasonCode);
	}
	...
	public void setBizId(String bizId) {
		this.bizId = StringUtils.trim(bizId);
	}
