...
//		me.potentialCustPlanInfo = Ext.create('PotentialCustPlanProgrammeGrid',{'potentialCustData':me.potentialCustData});
...
//					xtype:'fieldset',
//					autoScroll:true,
//					title:i18n('i18n.PotentialCustDetailView.potentialCustVisitRecord'),
//			        items:[me.potentialCustPlanInfo]}]
//			}
			]
		}];
...
//	Ext.create('PotentialCustDetailWindow',{potentialCustRecord:Ext.create('PotentialCustModel')}).show();
//});
