 ...
 * </p>
 * 
 * @title ContractWorkflowInfo.java
 * @package com.deppon.crm.module.customer.shared.domain
 * @author royxhl
 * @version 0.1 2013-11-19
 */
public class ContractWorkflowInfo extends BaseEntity {
	/** 
	 * @fields serialVersionUID 
	 */ 
	
	private static final long serialVersionUID = 4231513634384923217L;
	// 工作流编号
	...
	// 签署合同公司
	private String newSignCompany;
	// 发票标记
	private String newInvoiceType;
	//发票标记名称
	private String newInvoiceTypeName;
	//是否有零担折扣  true 包含 false 不包含
	
	private boolean isHasLTTDiscount; 
	//是否有快递折扣
	private boolean isHasExpDiscount;
	//是否只修改了快递折扣
	private boolean ismodifyInvoiceOnly;
	 ...
	 *            : set the property priceVersionDate.
	 */
	...
	public void setExpWxpgenerationRateDiscount(
			String expWxpgenerationRateDiscount) {
	...
	public void setNewSignCompany(String newSignCompany) {
		this.newSignCompany = newSignCompany;
	}
	...
	public boolean isHasLTTDiscount() {
		return isHasLTTDiscount;
	}

	public void setHasLTTDiscount(boolean isHasLTTDiscount) {
		this.isHasLTTDiscount = isHasLTTDiscount;
	}

	public boolean isHasExpDiscount() {
		return isHasExpDiscount;
	}

	public void setHasExpDiscount(boolean isHasExpDiscount) {
		this.isHasExpDiscount = isHasExpDiscount;
	}

	public boolean isIsmodifyInvoiceOnly() {
		return ismodifyInvoiceOnly;
	}

	public void setIsmodifyInvoiceOnly(boolean ismodifyInvoiceOnly) {
		this.ismodifyInvoiceOnly = ismodifyInvoiceOnly;
	}
	...
	public void setNewInvoiceTypeName(String newInvoiceTypeName) {
		this.newInvoiceTypeName = newInvoiceTypeName;
	}
