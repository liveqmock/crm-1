package com.deppon.crm.module.custview.server.service;
...
public interface IStatisticsService {
	 ...
	 * </p>
	 * @author 106143
	 * @version 0.1 2014-4-3下午6:32:57
	 * @param custId
	 * @param startDate
	 * @param endDate
	 * @return
	 * List<OperationAnalysis>
	 * @update 2014-4-3下午6:32:57
	 */
	 ...
	 * </p>
	 * @author 106143
	 * @version 0.1 2014-4-23下午2:55:12
	 * @param contactId
	 * @return
	 * List<CrossMapping>
	 * @update 2014-4-23下午2:55:12
	 */
	 ...
	 * </p>
	 * @author 106143
	 * @version 0.1 2014-4-30上午9:50:39
	 * @param object
	 * @param custId
	 * @param startDate
	 * @param endDate
	 * @return
	 * List<OperationAnalysis>
	 * @update 2014-4-30上午9:50:39
	 */
	List<OperationAnalysis> getLAMoneyByCondtion(String custId,
			Date startDate, Date endDate);
	/**
	 * <p>
	 * Description:获取发到货周期表中 发到货金额数据 
	 ...
	 * @update 2014-4-30上午9:50:39
	 */
	List<OperationAnalysis> getLAMoneyExpByCondtion(String custId,
			Date startDate, Date endDate);
}