...
public class orgManagerTest {
	...
	public void insert() throws Exception{
		...
		orgInfo.setParentOrgBenchmarkCode("DP01172");
		...
		orgInfo.setOrgBenchmarkCode("DP123");
		orgInfo.setParentOrgId("11061");
		orgInfo.setParentOrgBenchmarkCode("DP00506");
		...
		orgInfo.setTheMainCode("34");
		orgInfo.setTheMainId("158962");
