 ...
 * 
 * <p>
 * Description:工单责任 Service<br />
 * </p>
 * @title IDutyService.java
 * @package com.deppon.crm.module.duty.server.service 
 * @author 侯斌飞
...
public interface IDutyService {
	 ...
	 */
	List<DutyQueryResult> queryDutyApprovalList(
	 ...
	 * int
	 */
	int countQueryDutyApprovalList(QueryDutyCondition queryDutyCondition);
	/**
	 * <p>
	 ...
	 */
	Duty getDutyDetail(String dutyId);
	/**
	 * <p>
	 ...
	 * @version 0.1 2013-3-11
	 */
	List<DutyDealProcess> getDutyDealProcess(String dutyId);
	/**
	 * <p>
	 ...
	 * @version 0.1 2013-3-11
	 */
	List<DutyResult> getDutyResult(String dutyId);
	/**
	 * <p>
	 ...
	 * @version 0.1 2013-3-11
	 */
	List<String> getuserNameList(String dutyId);
	/**
	 * <p>
	 ...
	 */
	public void updateProcessPass(String processPass,String modifyUser,String dutuId);
