package com.deppon.crm.module.common.utils;
...
public class CodeInstallUtil {
	public static void main(String[] args) throws IOException {
		// mybatis
		// resultSql(BankProvince.class, "BP");
		// updateSql(BankProvince.class, "T_CRM_BANKPROVINCE");
//		InsertSql(BankProvince.class, "T_CRM_BANKPROVINCE");

		// pojoToMap(ContractInfo.class);
		pojoInstallValue(SyncDistrictRequest.class);
		// String txt = "OTHER/其它";
		// oracleTxt(txt, 704, "CARDTYPECON_NOTVIEW", 1);
	}
