...
@XmlType(name = "DepartmentInfo", namespace = "http://www.deppon.com/ows/inteface/domain/", propOrder = {
    ...
    "pickupExpressSelf",
    "deliveryExpress",
    "canReturnexpressSignBill",
    "canPickupExpress",
    "expressPickupAreaDesc",
    "expressDeliveryAreaDesc"
})
public class DepartmentInfo {
    ...
    protected String pickupExpressSelf;
    protected String deliveryExpress;
    protected String canReturnexpressSignBill;
    protected String canPickupExpress;
    protected String expressPickupAreaDesc;
    protected String expressDeliveryAreaDesc;

    public String getPickupExpressSelf() {
  		return pickupExpressSelf;
  	}

  	public void setPickupExpressSelf(String pickupExpressSelf) {
  		this.pickupExpressSelf = pickupExpressSelf;
  	}
  	...
  	public String getCanReturnexpressSignBill() {
  		return canReturnexpressSignBill;
  	}

  	public void setCanReturnexpressSignBill(String canReturnexpressSignBill) {
  		this.canReturnexpressSignBill = canReturnexpressSignBill;
  	}

  	public String getCanPickupExpress() {
  		return canPickupExpress;
  	}

  	public void setCanPickupExpress(String canPickupExpress) {
  		this.canPickupExpress = canPickupExpress;
  	}
