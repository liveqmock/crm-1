 ...
 * 			
 * 
 * <p>SyncSalesDepartmentResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
...
@XmlType(name = "SyncSalesDepartmentResponse", namespace = "http://www.deppon.com/ows/inteface/domain/", propOrder = {
    "failInfos"
})
public class SyncSalesDepartmentResponse {
