...
/**
 * <p>CreateCallCenterCustomerRequest complex type�� Java �ࡣ
 *
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 *
 * <pre>
 ...
 *         &lt;element name="linkmanInfos" type="{http://www.deppon.com/crm/inteface/cc/domain}LinkmanInfoCreate" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CreateCallCenterCustomerRequest", propOrder = {
    "custNumber",
    "custType",
    "ifBigCustomer",
    "custName",
...
public class CreateCallCenterCustomerRequest {
    ...
    protected List<LinkmanInfoCreate> linkmanInfos;
     ...
     * {@link LinkmanInfoCreate }
     *
     *
     */
    public List<LinkmanInfoCreate> getLinkmanInfos() {
        if (linkmanInfos == null) {
            linkmanInfos = new ArrayList<LinkmanInfoCreate>();
        }
