...
/**
 * <p>Java class for SendPositionResponse complex type.
 * 
 ...
 *         &lt;element name="processResult" type="{http://www.deppon.com/uums/inteface/domain/usermanagement}SendPositionProcessReult" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SendPositionResponse", propOrder = {
    "successCount",
    "failedCount",
    "processResult"
})
public class SendPositionResponse {
     ...
     * {@link SendPositionProcessReult }
     * 
     * 
     */
    public List<SendPositionProcessReult> getProcessResult() {
        if (processResult == null) {
            processResult = new ArrayList<SendPositionProcessReult>();
        }
