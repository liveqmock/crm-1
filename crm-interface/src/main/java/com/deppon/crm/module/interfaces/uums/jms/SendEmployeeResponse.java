...
/**
 * <p>Java class for SendEmployeeResponse complex type.
 * 
 ...
 *         &lt;element name="processResult" type="{http://www.deppon.com/uums/inteface/domain/usermanagement}SendEmployeeProcessReult" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SendEmployeeResponse", propOrder = {
    "successCount",
    "failedCount",
    "processResult"
})
public class SendEmployeeResponse {
     ...
     * {@link SendEmployeeProcessReult }
     * 
     * 
     */
    public List<SendEmployeeProcessReult> getProcessResult() {
        if (processResult == null) {
            processResult = new ArrayList<SendEmployeeProcessReult>();
        }
