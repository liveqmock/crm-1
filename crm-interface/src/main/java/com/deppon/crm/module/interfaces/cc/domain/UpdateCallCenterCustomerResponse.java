...
/**
 * <p>UpdateCallCenterCustomerResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="UpdateCallCenterCustomerResponse">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateCallCenterCustomerResponse", propOrder = {
    "ifSuccess",
    "errorMsg"
})
public class UpdateCallCenterCustomerResponse {
