package com.deppon.crm.module.organization.server.manager;
/**.
 * 
...
public interface ISearchDeptAndEmployeeManager {
	 ...
	 * @since JDK1.6
	 */
	public List<UserInfo> searchEmpByCondition(SearchEmpAndDeptCondition condition,int start,int limit);
